...
Description"
  ...
  assert_file_exist "${TEST_TEMP_DIR}/Test-Project/.github/workflows/publish-upm-package.yml"
  ...
  assert_file_contains "${TEST_TEMP_DIR}/Test-Project/.npmrc" "upm.sample2.dev"
...
Description"
  ...
  assert_file_exist "${TEST_TEMP_DIR}/Test-Project/Assets/package.json"
  assert_file_exist "${TEST_TEMP_DIR}/Test-Project/ProjectSettings/ProjectSettings.asset"
  assert_file_contains "${TEST_TEMP_DIR}/Test-Project/.npmrc" "upm2.sample2.dev"
...
@test "upm-init / multiple registries configured (parameters)" {
  ...
  assert_file_exist "${TEST_TEMP_DIR}/Test-Project/Assets/package.json"
  assert_file_exist "${TEST_TEMP_DIR}/Test-Project/ProjectSettings/ProjectSettings.asset"
  assert_file_contains "${TEST_TEMP_DIR}/Test-Project/.npmrc" "upm1.sample2.dev"
